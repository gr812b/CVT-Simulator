...
class TestTheoreticalModels(unittest.TestCase):
    ...
    def test_outer_prim_radius(self):
        self.assertAlmostEqual(TheoreticalModels.outer_prim_radius(-3.955310010320904e-06), 0.0346202)  # Replace with actual expected value

    def test_outer_sec_radius(self):
        self.assertAlmostEqual(TheoreticalModels.outer_sec_radius(-3.955255), 0.1015999999)  # Replace with actual expected value

    def test_current_cvt_ratio(self):
        self.assertAlmostEqual(TheoreticalModels.current_cvt_ratio(-3.955255), 3.4959772834831964)  # Replace with actual expected value
    ...
    def test_primary_wrap_angle(self):
        self.assertAlmostEqual(TheoreticalModels.primary_wrap_angle(-3.955289409632892e-06), 2.8769331104525517)  # Replace with actual expected value

    def test_secondary_wrap_angle(self):
        self.assertAlmostEqual(TheoreticalModels.secondary_wrap_angle(-3.955289409632892e-06), 3.4062521967270345)  # Replace with actual expected value

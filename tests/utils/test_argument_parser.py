...
class TestArgumentParser(unittest.TestCase):
    ...
    @patch('sys.argv', ['program_name', '--flyweight_mass', '0.8', '--primary_ramp_geometry', '1.0',
                        '--primary_spring_rate', '600.0', '--primary_spring_pretension', '0.3',
                        '--secondary_helix_geometry', '1.0', '--secondary_torsion_spring_rate', '150.0',
                        '--secondary_compression_spring_rate', '150.0', '--secondary_spring_pretension', '20.0',
                        '--vehicle_weight', '250.0', '--driver_weight', '80.0', '--traction', '90.0',
                        '--angle_of_incline', '10.0'])  # Mock the args here for the custom test

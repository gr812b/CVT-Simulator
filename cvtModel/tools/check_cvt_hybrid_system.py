...
Run from the repository root:
    ...
    python tools/check_cvt_hybrid_system.py
    python tools/check_cvt_hybrid_system.py --scenario upper_stop
    python tools/check_cvt_hybrid_system.py --scenario one_second
    python tools/check_cvt_hybrid_system.py --save-dir artifacts/cvt_system_checks
"""
...
from cinder.integration.cvt_system_checks import (  # noqa: E402

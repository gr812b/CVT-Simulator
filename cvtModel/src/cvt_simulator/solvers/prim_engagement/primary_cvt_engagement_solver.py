...
def main():
    ...
    if result.success:
        ...
        print(f"✓ Primary pulley engages at {engagement_rpm:.1f} RPM ({result.value:.2f} rad/s)")
    else:
    ...
    if result.success and result.value is not None:
        ...
        ax.plot(engagement_rpm, 0, 'ro', markersize=10, 
    ...
    ax.set_title('Primary Pulley Engagement Curve\n(Maximum Torque vs Engine Speed)', 

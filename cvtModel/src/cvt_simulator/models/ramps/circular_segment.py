...
class CircularSegment(RampSegment):
    ...
    def __init__(
        ...
        self.theta_start = self._slope_angle_to_position_angle(angle_start_rad, quadrant)
    ...
    def _slope_angle_to_position_angle(self, slope_angle_rad: float, quadrant: int) -> float:
        """

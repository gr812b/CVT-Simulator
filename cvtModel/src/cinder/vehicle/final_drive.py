...
class FixedFinalDrive:
    ...
    def __post_init__(self) -> None:
        _require_positive("reduction_ratio", self.reduction_ratio)
        _require_positive("wheel_radius", self.wheel_radius)
    ...
    def wheel_angular_speed(
        ...
        *,
        ...
        """Return omega_wheel = omega_secondary / G."""
    ...
    def vehicle_speed(
        ...
        *,
        ...
        """Return v = r_w omega_secondary / G."""
    ...
    def secondary_torque_from_wheel_force(
        ...
        *,
        ...
        """Return tau_secondary = F_wheel r_w / G."""
    ...
    def secondary_inertia_from_vehicle_mass(
        ...
        *,
        ...
        """
        Return vehicle translational inertia referred to the secondary shaft.

            J_vehicle->secondary = m (r_w / G)^2
        """
    ...
    def secondary_inertia_from_wheel_rotation(
        ...
        *,
        ...
        """
        Return driven-wheel rotational inertia referred to the secondary shaft.

            J_wheels->secondary = J_wheels / G^2
        """

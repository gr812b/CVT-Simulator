...
CINDER 1.1.2 uses a different normal-force convention. Its reduced contact law
...
which gives the CINDER 1.1.2 translation
...
pre-PR471 normal-force convention and must not be used with the released 1.0.0-or-later mechanics used by this study
axial balance.

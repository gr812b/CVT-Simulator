...
results from `continue_multiroot_branches.py`), it reconstructs the same frozen
state and then:
...
From results/cinder-v1.1.2:
    ...
    python .\studies\closure-conditioning\visualize_multiroot_manifold.py `
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument('--continuation-dir', type=Path, required=True,
                   help='Directory containing branch_A.csv and branch_B.csv from continue_multiroot_branches.py.')

...
Search strategy
---------------
Stage 0: audit any candidates already found by `search_multiroot_operating_point.py`.
...
From results/cinder-v1.1.2:
    ...
    python .\studies\closure-conditioning\search_comfortable_multiroot_states.py `

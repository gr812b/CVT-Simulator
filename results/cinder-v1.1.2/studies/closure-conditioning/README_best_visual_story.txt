...
3. render_multiroot_story_gif.py
...
From results/cinder-v1.1.2:
  ...
  python .\studies\closure-conditioningind_best_visual_multiroot_story.py `
    --global-search-dir .\studies\closure-conditioningrtifacts\global-comfortable-multiroot-search `
    --reference-path-csv .\studies\closure-conditioningrtifacts\controlled-free-shift-animation\expanded_res641_locked_locked_path\preflight_path.csv `
    --reference-frame 60 `
    --top-k 8 `
    --vary secondary `
    --frames 72 `
...
The master script writes to:
  ...
  studies\closure-conditioningrtifactsest-visual-multiroot-story
Inside the chosen best candidate folder you should find:
  * continuation\candidate_...ary_secondary_torque\...
  * manifold\...
...
---------------------------------------------
  ...
  python .\studies\closure-conditioningender_multiroot_story_gif.py `

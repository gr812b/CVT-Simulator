r"""Render a full-run 4x2 closure-conditioning GIF from saved map files.
...
Recommended usage from results/cinder-v1.1.2:
    ...
    python .\studies\closure-conditioning\exploration/render_full_4x2_share_bundle_gif.py ^

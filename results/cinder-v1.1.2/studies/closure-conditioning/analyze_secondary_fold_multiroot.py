"""Analyze folded R_s = 0 structure and search for possible multiple stick-stick roots.
...
Recommended usage from results/cinder-v1.1.2:
    ...
    python .\studies\closure-conditioning\analyze_secondary_fold_multiroot.py ^

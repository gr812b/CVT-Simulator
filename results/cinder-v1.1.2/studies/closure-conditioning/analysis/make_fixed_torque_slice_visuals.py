r"""Create focused fixed-torque slice visuals from a multiroot manifold directory.
...
------------------------
A manifold directory produced by analysis/visualize_multiroot_manifold.py, containing:

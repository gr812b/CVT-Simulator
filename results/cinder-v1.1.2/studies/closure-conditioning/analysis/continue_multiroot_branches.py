...
`exploration/global_comfortable_multiroot_search.py`, freezes the mechanical state, and
...
--------------------------------------
    ...
    python .\studies\closure-conditioning\analysis/continue_multiroot_branches.py `

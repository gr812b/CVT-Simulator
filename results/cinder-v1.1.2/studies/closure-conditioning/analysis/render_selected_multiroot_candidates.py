...
This is a follow-on helper for `exploration/search_multiroot_operating_point.py`.
...
Typical usage from `results/cinder-v1.1.2`:
    ...
    python .\studies\closure-conditioning\analysis/render_selected_multiroot_candidates.py `

r"""Robust connected-contour audit for possible multiple stick-stick roots.
...
Typical usage from results/cinder-v1.1.2:
    ...
    python .\studies\closure-conditioning\analysis/analyze_connected_multiroot_contours.py `

...
def main():
    ...
    print("PASS actuator-dynamics v2 study verification")
    print(f"  CINDER: {EXPECTED_VERSION}")
    print(f"  release commit: {commit}")
    print("  official experiments: baseline ablation, coupling energy, validity envelopes, controlled transients")
    return 0

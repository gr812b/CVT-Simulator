...
| Actuator dynamics / coupling | **NEXT — PROMOTE + REDESIGN EXPLORATION** | Formalize baseline studies first, then design stronger off-baseline questions. |
...
3. Promote and clean the **baseline actuator ablation + coupling-energy decomposition** into one `actuator-dynamics` study.

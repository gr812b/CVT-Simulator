...
class BeltSimulator:
  ...
  def calculate_centrifugal_force(self, ω: float, shift_distance: float, sheave_angle: float, wrap_angle: float) -> float:
  ...
  def radial_force_from_clamping(self, clamping_force: float, sheave_angle: float) -> float:

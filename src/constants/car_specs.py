...
BELT_WIDTH = 0.85 * INCH_TO_METER  # m
BELT_HEIGHT = 0.59 * INCH_TO_METER  # m
BELT_CROSS_SECTIONAL_AREA = 0.0002838704  # m^2
INNER_PRIMARY_PULLEY_RADIUS = 0.8125 * INCH_TO_METER  # m
INNER_SECONDARY_PULLEY_RADIUS = 0.969 * INCH_TO_METER  # m
INITIAL_FLYWEIGHT_RADIUS = 0.05  # m
HELIX_RADIUS = 0.04445  # m
CENTER_TO_CENTER = 0.5  # m

# Calculated constant
MAX_SHIFT = BELT_WIDTH - BELT_HEIGHT*np.tan(SHEAVE_ANGLE/2)

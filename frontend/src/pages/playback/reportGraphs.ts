...
const CHARTS: Array<{ category: string; chart: Chart }> = [
  ...
  { category: 'Acceleration of Engine and Car', chart: { title: 'Torques at Secondary Shaft vs Time', x: 'time_s', xLabel: 'Time', yLabel: 'Torque', series: [{ key: 'contact.secondary_transmitted_torque', label: 'Secondary Torque' }, { key: 'boundary.secondary_external_torque', label: 'External Load Torque' }], tooltip: TooltipPosition.TopRight } },
  { category: 'Acceleration of Engine and Car', chart: { title: 'Torques at Engine vs Time', x: 'time_s', xLabel: 'Time', yLabel: 'Torque', series: [{ key: 'contact.primary_transmitted_torque', label: 'Primary Torque' }, { key: 'boundary.primary_external_torque', label: 'Engine Torque' }], tooltip: TooltipPosition.TopRight } },
  ...
  { category: 'Engine', chart: { title: 'Engine Torque vs Time', x: 'time_s', xLabel: 'Time', yLabel: 'Engine Torque', series: [{ key: 'boundary.primary_external_torque', label: 'Engine Torque' }], tooltip: TooltipPosition.TopRight } },
  ...
  { category: 'Belt Tension', chart: { title: 'Belt Tensions vs Time', x: 'time_s', xLabel: 'Time', yLabel: 'Tension', series: [{ key: 'contact.primary_tension_in', label: 'Primary In' }, { key: 'contact.primary_tension_out', label: 'Primary Out' }, { key: 'contact.secondary_tension_in', label: 'Secondary In' }, { key: 'contact.secondary_tension_out', label: 'Secondary Out' }], tooltip: TooltipPosition.TopRight } },

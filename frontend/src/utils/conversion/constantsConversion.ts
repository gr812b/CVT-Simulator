...
export function convertConstants(
  ...
  return {
    ...
    min_effective_cvt_ratio: conv(constants.min_effective_cvt_ratio, 'dimensionless'),
    max_effective_cvt_ratio: conv(constants.max_effective_cvt_ratio, 'dimensionless'),
  };
}

...
To promote this flexibility each team member is also assigned a backup role if the primary role taker is not available.
...
\begin{itemize}
  ...
  \item Backup Roles: Reviewer, Frontend Lead
\end{itemize}
...
\begin{itemize}
	...
	\item Backup Roles: Meeting Chair, Project Manager
\end{itemize}
...
\begin{itemize}
  ...
  \item Backup Roles: Note Taker, Backend Lead
\end{itemize}
...
\begin{itemize}
	...
	\item Backup Roles: Issue Manager, Product Owner
\end{itemize}

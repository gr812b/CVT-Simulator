...
place.}
  ...
  %Yes: We don't want to leak our current tunning settings for the CVT so the default will be set to differnet values.
  %No: I don't think we have any true confidential information otherwise and don't want to do the work to make it confidential.
...
%Discuss with all team memebers at meeting
% Show technical ability to solve complex problems
% Be able to deliver a large project on time

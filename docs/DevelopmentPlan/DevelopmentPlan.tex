...
This project will track items based on existing items, items that are in progress and completed items. Each item is intended to have a description and the team of the team member/members who will be working on the item.
...
Additionally, there is a section to monitor the progress of items and will contain the information on tasks/features that are actively being worked on my team members. 

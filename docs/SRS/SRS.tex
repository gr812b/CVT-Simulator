...
\newcommand{\utheulcnum}{ULC\theulcnum}
...
\hline
\rowcolor[gray]{0.9}
Number& DD\refstepcounter{datadefnum}\thedatadefnum \label{DD_\thedatadefnum}\\
\hline
Label& \bf #2\\
\hline
Symbol & #3\\
...
\item[A\refstepcounter{assumpnum}\theassumpnum \label{A_11}:]
...
Now we can use \ddref{DD_7}, \dref{GD_3} to substitute power in for the engine torque and the engine angular velocity.

...
April 1 & 2.0 & Added Security Requirements \\
\bottomrule
\end{tabularx}
...
{The user will input the geometry of the helix, which will then be interpreted to generate $f_\text{sec}$}% #6 Notes
{N/A}% #7 Source
{}% #8 Referenced by
{None}% #9 Preconditions
{}% #1 derivation - not applicable by default
...
See VnV Plan Section 4.2 for the test procedure. An accuracy rate of 95\% ensures that the system is able to make reliable predictions, which are important to the performance optimization. 

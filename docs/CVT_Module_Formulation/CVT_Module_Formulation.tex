...
Here, \(F_{\mathrm{ax},j}\) is clamping force only; belt inertia
(centrifugal effects) is already accounted for by the acceleration term in
\Eq{eq:deltaT_final}.
...
\widebigeq{eq:tau_p_plus_stick}{Primary Stick-Branch Upper Bound}{
...
\widebigeq{eq:tau_p_minus_stick}{Primary Stick-Branch Lower Bound}{
\tau_{c,p,-}^{\mathrm{stick}}
=
-\frac{
r_{p,\mathrm{eff}}
...
\widebigeq{eq:tau_p_plus_slip}{Primary Slip-Branch Upper Bound}{
\tau_{c,p,+}^{\mathrm{slip}}
=
r_{p,\mathrm{eff}}
\Biggl\{
...
\widebigeq{eq:tau_p_minus_slip}{Primary Slip-Branch Lower Bound}{
\tau_{c,p,-}^{\mathrm{slip}}
=
-
r_{p,\mathrm{eff}}
...
\widebigeq{eq:tau_s_plus_stick}{Secondary Stick-Branch Upper Bound}{
...
\widebigeq{eq:tau_s_minus_stick}{Secondary Stick-Branch Lower Bound}{
\tau_{c,s,-}^{\mathrm{stick}}
=
-\frac{
\dfrac{r_{s,\mathrm{eff}}}{R}
...
\widebigeq{eq:tau_s_plus_slip}{Secondary Slip-Branch Upper Bound}{
\tau_{c,s,+}^{\mathrm{slip}}
=
\frac{
\dfrac{r_{s,\mathrm{eff}}}{R}
...
\widebigeq{eq:tau_s_minus_slip}{Secondary Slip-Branch Lower Bound}{
\tau_{c,s,-}^{\mathrm{slip}}
=
-\frac{
\dfrac{r_{s,\mathrm{eff}}}{R}
...
The full CVT state vector $\mathbf{x} = (\omega_p, \omega_s, s, \dot{s}, \hat v_b)$
...
dynamics for $\hat v_b$, and algebraic geometry closures

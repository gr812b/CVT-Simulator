...
At this point, every free body retained in the engaged CVT model has been
balanced. The movable sheaves have their axial equations of motion, the two
pulley assemblies have their rotational equations of motion, and the belt has
been treated through both pulley wraps and both massive straight spans. The
wrap balances provide the tension and normal-loading distributions from which
the belt axial reactions and pulley torques are obtained, while the
straight-span balances complete the dynamics of the closed belt.
...
With the belt loop now closed, every retained mechanical free body has been
balanced. The only remaining unknowns are the two wrap-level traction
utilizations, \(\lambda_p\) and \(\lambda_s\). The next section establishes
the contact-state relations needed to determine them.

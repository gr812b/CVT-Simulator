...
Deriving the individual mechanical balances does not by itself show that they
remain mutually compatible when the complete CVT is solved. Belt--pulley
contact, for example, enters the belt balances, the axial sheave reactions,
and the pulley torques at the same time, while the active contact and support
relations change with mechanical regime. Internal verification therefore asks
whether the assembled model preserves that consistency across the states and
regime changes it admits.

That requirement separates naturally into four parts. The operating-domain
audit tests whether the governing equations and admissibility conditions
remain satisfied across the represented regimes. The energy audit provides an
independent global check that the coupled mechanics exchange, store, and
dissipate energy consistently. Solver refinement tests whether both the
continuous response and the discrete regime history persist as the numerical
controls are tightened. Finally, the closure study isolates the instantaneous
engaged solve, examining its conditioning and the uniqueness and global
structure of the traction roots required to close sticking contact.

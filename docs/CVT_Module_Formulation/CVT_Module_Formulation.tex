...
The belt is represented everywhere along its length by the same prescribed
cross-sectional shape and dimensions. This cross-section remains unchanged as
the belt runs and shifts. It may bend along the modeled belt path, but it does
not compress, bulge, shear, or warp under centrifugal or sheave loading.

Mass density is taken to be uniform through this idealized cross-section and
along the belt. The belt therefore has one constant mass per unit length, and
its cross-sectional centre of mass lies at the geometric centroid. The cord
layer is retained as a prescribed tension-carrying line at the fixed depth
\(d_{\mathrm{cord}}\), but the different density of the cords and surrounding
rubber is not resolved in the mass distribution.

\AssumptionConsequences
The smooth, uniform section replaces spatial variations caused by cogs, ribs,
joints, local reinforcement, manufacturing variation, or nonuniform wear.
Concentrated cord mass and differences between the densities of the belt
layers cannot shift the modeled centre of mass away from the geometric
centroid.

Lateral and radial compression, bulging, cross-sectional shear and warping,
centrifugal growth, and local cog or rib deformation are also not resolved.
The resulting load-dependent changes in belt width, height, contact geometry,
mass distribution, and internal strain energy therefore lie outside the
present formulation. Detailed belt models retain some of these spatial and
compliance effects explicitly
...
transverse belt vibration, and transverse inertia associated with
straight-span reorientation are omitted. The same planar description also
excludes the out-of-plane span skew, twist, and axial belt inertia that would
arise when the two physical groove centerplanes move differently during
shift. More detailed belt and shift-mechanics models resolve subsets of these
path effects explicitly
...
contact resultants, clamping, traction limitation, gross stick--slip mechanics,
and momentum redistribution when a new mechanical constraint activates. They
also retain the kinetic-energy loss associated with gross slip and perfectly
inelastic capture.

The formulation does not reproduce the complete deformable belt and local
contact problem, spatial variation within the belt construction, slack-belt
dynamics while the primary is disengaged, actuator tribology,
flexible-structure response, finite-duration impact and rebound, impulse-level
friction limits, thermal or wear evolution, or miscellaneous parasitic losses.
The assumptions are separated by physical mechanism so that a higher-fidelity
model can replace one closure without obscuring which additional behaviour

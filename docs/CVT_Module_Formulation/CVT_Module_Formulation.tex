...
\paragraph{Generic pulley-wrap equation}

The radial and tangential equations now describe the same belt element in
terms of the same normal-load gradient. Solving
\Cref{eq:wrap_radial_balance} for that gradient gives
...
Substitution into \Cref{eq:wrap_tangential_balance} removes the internal normal
load and leaves a single differential equation for the belt tension through
the wrap,
...
Collecting the tension term gives the standard linear first-order form,
...
The coordinate \(\theta\) increases with belt travel on either pulley, and the
sign of the tangential contact is carried by \(\lambda_j\). The same equation
therefore governs tension evolution through the primary and secondary wraps
without a separate sign convention for each pulley.

...
The definition proceeds from the outside inward. The CVT boundary and its
external mechanical interfaces are established first, followed by the
assumptions that determine the physical detail retained. Coordinates and sign
conventions then define how the retained motions are measured. From these
choices, the internal state, operating regimes, and instantaneous unknowns of

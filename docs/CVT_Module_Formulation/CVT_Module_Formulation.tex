...
% TODO: Replace the temporary belt-cross-section fallback with the final figure asset.
\begin{figure}[H]
\centering
...
apply within the deadzone and engaged branches, while crossing the boundary
between them is treated as a regime transition.
\end{remarkbox}
...
\begin{itemize}
    % TODO: Replace the placeholder release tag with the final archived version.
    \item repository release (to be finalized):
      \url{https://github.com/gr812b/CVT-Simulator/releases/tag/vX.Y.Z},
    % TODO: Replace the placeholder DOI with the final archival DOI before submission.

...
The cleanest way to see how those two structural changes alter the mechanics
is to follow the primary from fully open into engagement and then through
upshift. Along that path, only two things modify a previously derived free
body: the primary belt contact can appear or disappear, and a travel stop can
add the support reaction required to prevent further axial motion. The rest
of the pulley, belt, and contact mechanics remain the same.
...
\(\lambda_s\) are selected with the same tangential-regime logic already developed
in \Cref{sec:engaged_dynamic_closure}.
...
As at low ratio, the stop reaction is a separate hardware load path rather

...
Let \(\hat{v}_b\) denote the modeled belt transport speed introduced in the
system state. The corresponding angular velocity of the belt mass centroid
on pulley \(j\) is then
...
The axial force models developed in \Sec{sec:axial} depend on the

...
approximately at the mid-height of the belt.
...
These effective radii are used in all subsequent torque calculations.
...
% TODO: Fill in parameter tables for reference implementation


\section{Belt Length Small-Angle Approximation}\label{sec:approximation-validation}

This section quantifies the error introduced by the small-angle approximation
commonly used in simplified CVT kinematic models.
...
This section catalogs several common ramp profile parameterizations
used in CVT primary pulley actuation.
...
\begin{itemize}
\item Uniform force multiplication across the shift range
\item Simple to manufacture and analyze
\item May not provide optimal shift feel or calibration flexibility
\end{itemize}

\subsection{Quadratic Ramp}

% TODO: Derive force-balance for quadratic profile $r_f(s) = r_{f,0} + as + bs^2$

\subsection{Piecewise-Linear Ramp}

% TODO: Document multi-stage ramp designs with different slopes in different shift regions

\subsection{Custom Profiles from Lookup Tables}

% TODO: Discuss spline or lookup-table based ramp profiles for advanced tuning
...
The belt-length constraint \Eq{eq:belt_length_constraint} is solved using
Brent's method, a robust bracketed root-finding algorithm combining bisection,
secant, and inverse quadratic interpolation.

% TODO: Document bracketing strategy and typical convergence behavior

\subsection{ODE Integration for Dynamic Simulation}

% TODO: Document choice of integrator (e.g., RK45, BDF) and step size strategy


\section{Nomenclature and Symbol Reference}\label{sec:appendix-nomenclature}

% TODO: Comprehensive table of all symbols used in the document
% Organized by category: geometry, forces, dynamics, parameters, etc.

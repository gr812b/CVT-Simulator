...
\textbf{Placeholder: tight/slack tensions on a wrapped pulley.}
Draw pulley with wrap angle $\phi$.
Label $T_{\mathrm{slack}}$ on the entering span,
$T_{\mathrm{tight}}$ on the leaving span,
and indicate belt motion direction.
Show effective radius $r_{\mathrm{eff}}$.
}}

...
April 3rd, 2025 & 1.3 & Updated tests, added modules\\
\bottomrule
\end{tabularx}
...
These meetings will focus on the theoretical models, data definitions, and instance cvt_simulator.models.
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{PositionTest-1}{\textbf{Position test-1}} \label{PositionTest-1}
  ...
  \item \phantomsection \hypertarget{PositionTest-2}{\textbf{Position test-2}} \label{PositionTest-2}
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{Velocity test-1}{\textbf{Velocity test-1}} \label{Velocity test-1}
...
\item \phantomsection \hypertarget{Velocity test-2}{\textbf{Velocity test-2}} \label{Velocity test-2}
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{Acceleration test-1}{\textbf{Acceleration test-1}} \label{Acceleration test-1}
  ...
  \item \phantomsection \hypertarget{Acceleration test-2}{\textbf{Acceleration test-2}} \label{Acceleration test-2}
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{Clamping forces test-1}{\textbf{Clamping forces test-1}} \label{Clamping forces test-1}
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{Shift test-1}{\textbf{Shift test-1}} \label{Shift test-1}
  ...
  \item \phantomsection \hypertarget{Shift test-2}{\textbf{Shift test-2}} \label{Shift test-2}
  ...
  \item \phantomsection \hypertarget{Shift test-3}{\textbf{Shift test-3}} \label{Shift test-3}
  ...
  \item \phantomsection \hypertarget{Shift test-4}{\textbf{Shift test-4}} \label{Shift test-4}
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{Engine test-1}{\textbf{Engine test-1}} \label{Engine test-1}
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{User Interface test-1}{\textbf{User Interface test-1}} \label{User Interface test-1}
  ...
  \item \phantomsection \hypertarget{User Interface test-2}{\textbf{User Interface test-2}} \label{User Interface test-2}
  ...
  \item \phantomsection \hypertarget{User Interface test-3}{\textbf{User Interface test-3}} \label{User Interface test-3}
  ...
  \item \phantomsection \hypertarget{User Interface test-4}{\textbf{User Interface test-4}} \label{User Interface test-4}
...
\end{itemize}
  ...
  \begin{enumerate}
    \item \phantomsection \hypertarget{Compatibility test-1}{\textbf{Compatibility test-1}} \label{Compatability test-1}
...
\begin{enumerate}
  \item \phantomsection \hypertarget{Accuracy test-1}{\textbf{Accuracy test-1}} \label{Accuracy test-1}
...
\begin{enumerate}
  \item \phantomsection \hypertarget{Usability test-1}{\textbf{Usability test-1}} \label{Usability test-1}
...
\item \phantomsection \hypertarget{Usability test-2}{\textbf{Usability test-2}} \label{Usability test-2}
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{Maintainability test-1}{\textbf{Maintainability test-1}} \label{Maintainability test-1}
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{Verifiability test-1}{\textbf{Verifiability test-1}} \label{Verifiability test-1}
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{Understandability test-1}{\textbf{Understandability test-1}} \label{Understandability test-1}
...
See the usability/understandability survey in section \ref{sec:Usability Survey Questions}. 
 ...
 \item \phantomsection \hypertarget{Understandability test-2}{\textbf{Understandability test-2}} \label{Understandability test-2}
...
\begin{enumerate}
  ...
  \item \phantomsection \hypertarget{Reusability test-1}{\textbf{Reusability test-1}} \label{Reusability test-1}
...
\subsection{Tests for Safety Requirements}

\noindent This section briefly summarizes the safety requirements tests. The focus is on verifying that dynamic adjustments to safety metrics and robust error handling mechanisms function correctly to maintain system integrity under varying conditions.


\subsubsection{Test for Safety Requirement 1}
\begin{enumerate}

  \item \phantomsection \hypertarget{SR1 Test-1}{\textbf{SR1 Test-1}} \label{SR1 Test-1}
    
Type: Manual
              
Initial State: Running software under normal conditions
              
Input/Condition: Input a value into the simulation that will cause an increase in the belt tension beyond the maximum limit.
              
Output/Result: The system should notify the user of the belt tension exceeding the maximum limit and stop the simulation.
              
How test will be performed: The test will be performed by running the software under normal conditions and then inputting a value that causes the simulation to exceed the maximum belt tension.
The system should notify the user of the belt tension exceeding the maximum limit and stop the simulation. The user should be able to see the error message and understand what went wrong.
    

\end{enumerate}

\subsubsection{Test for Safety Requirement 2}
\begin{enumerate}

  \item \phantomsection \hypertarget{SR2 Test-1}{\textbf{SR2 Test-1}} \label{SR2 Test-1}
    
Type: Manual
              
Initial State: Running software under normal conditions
              
Input/Condition: Input that will cause the system to throw an error.
              
Output/Result: The system should throw an error and stop the simulation, and the user should be notified of the error with a means of debugging.
              
How test will be performed: The test will be performed by running the software under normal conditions and then inputting a value that causes the simulation to throw an error.
The system should throw an error and stop the simulation, and the user should be notified of the error with a means of debugging. The user should be able to see the error message and understand what went wrong.
  ...
  \begin{table}[h!]
    \centering
      \begin{tabular}{|c|c|}
        \hline
        \textbf{Requirement} & \textbf{Test(s)} \\ \hline
        SR1 & \textcolor{blue}{\hyperlink{SR1 Test-1}{SR1 Test-1}}  \\ \hline
        SR2 & \textcolor{blue}{\hyperlink{SR2 Test-1}{SR2 Test-1}}\\ \hline
        \end{tabular}
        \caption{System Safety Requirements and Corresponding Tests}
        \label{tab:requirements_tests}
    \end{table}
...
\begin{itemize}
  ...
  \label{test:belt_simulator} - This test suite will verify that the BeltSimulator’s methods correctly compute centrifugal force, clamping-derived radial forces, net radial force, slack tension, and maximum transferable torque according to theoretical cvt_simulator.models.
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|p{10cm}|} % Fixed width for the second column
      \hline

...
\noindent Software Requirements Specification \citet{SRS}
\newline
...
\newline
\noindent Module Interface Specification \citet{MIS}
\newline
\newline
\noindent Verification and Validation Report \citet{VnVReport}
\newline
...
\begin{enumerate}
  \item The system will undergo reviews from fellow classmates, providing our team with quality feedback from an outside perspective. 
  \item The system will receive Stakeholder review providing us with relevant feedback on teh functionality and interface of our design. 
  \item The system will undergo Specification testing to focus on the functionality of the system. This will include testing for our requirements, testing our mathematical calculations and accuracy of our model. 
\end{enumerate}

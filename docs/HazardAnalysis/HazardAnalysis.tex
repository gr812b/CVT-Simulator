...
~\newline
This component is responsible for taking user input, providing the output to the user, and displaying the simulation of the 3D cvt_simulator.models.\\
~\newline
...
\begin{table}[ht]
    ...
    \end{itemize} 
    & \begin{itemize}[left=0pt]
        \item Incorrect distribution of forces across the pulleys due to inaccurate mass or load cvt_simulator.models.
    ...
    \end{itemize} &
    \begin{itemize}[left=0pt]
        \item Investigate friction assumptions and cvt_simulator.models.

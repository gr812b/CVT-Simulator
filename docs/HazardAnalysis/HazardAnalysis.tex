...
March 18 & Grace McKenna & Added traceability to document and addressed why no UI requirements \\
April 1 & Grace McKenna & Added link to SRS\\
\bottomrule
\end{tabularx}
\end{table}
...
Note that the Requirements R18, R19, R20 and R21 can be found in the \href{https://github.com/gr812b/CVT-Simulator/blob/main/docs/SRS/SRS.pdf#page=40}{SRS document}.

...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
\multicolumn{4}{l}{\textbf{RampSegment (Abstract Base Class)}} \\
\hline
height & x: \(\mathbb{R}\) & y-coordinate: \(\mathbb{R}\) & NotImplemented \\
slope  & x: \(\mathbb{R}\) & derivative: \(\mathbb{R}\) & NotImplemented \\
\hline
\multicolumn{4}{l}{\textbf{LinearSegment (Inherits RampSegment)}} \\
\hline
\texttt{LinearSegment} (Constructor) & x\_start: \(\mathbb{R}\), x\_end: \(\mathbb{R}\), slope: \(\mathbb{R}\) & LinearSegment instance & - \\
\hline
height & x: \(\mathbb{R}\) & \( y = m \times (x - x_{start}) + y_{start} \) & - \\
slope  & x: \(\mathbb{R}\) & \( m \) & - \\
\hline
\multicolumn{4}{l}{\textbf{CircularSegment (Inherits RampSegment)}} \\
\hline
\texttt{CircularSegment} (Constructor) & x\_start: \(\mathbb{R}\), x\_end: \(\mathbb{R}\), radius: \(\mathbb{R}\), theta\_start: \(\mathbb{R}\), theta\_end: \(\mathbb{R}\) & CircularSegment instance & \begin{tabular}[c]{@{}l@{}}ValueError if\\ 1) \(\theta_{start}\) or \(\theta_{end}\) \\ not in \([0,\pi/2]\)\\ 2) \(\theta_{start} \ge \theta_{end}\)\end{tabular} \\
\hline
helpful\_guy & \(\theta: \mathbb{R}\) & offset: \(\mathbb{R}\) & - \\
f & x: \(\mathbb{R}\) & \( y = -\sqrt{radius - x^2} \) & - \\
f\_prime & x: \(\mathbb{R}\) & derivative: \(\mathbb{R}\) & - \\
map\_x & x: \(\mathbb{R}\) & adjusted x: \(\mathbb{R}\) & - \\
height & x: \(\mathbb{R}\) & computed y-coordinate: \(\mathbb{R}\) & - \\
slope  & x: \(\mathbb{R}\) & computed slope: \(\mathbb{R}\) & - \\
\hline
\multicolumn{4}{l}{\textbf{PiecewiseRamp}} \\
\hline
\texttt{PiecewiseRamp} (Constructor) & None & PiecewiseRamp instance & - \\
\hline
add\_segment & segment: \texttt{RampSegment} & None & - \\

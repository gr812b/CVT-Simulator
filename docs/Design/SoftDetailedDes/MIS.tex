...
\section{MIS of Hardware Hiding Module} \label{Module_hardware_hiding} \wss{Use labels for
  cross-referencing}
...
\section{External Forces Module} \label{Module_external_forces} \wss{Use labels for
  cross-referencing}
...
\section{MIS of Input Module} \label{Module_input} \wss{Use labels for
  cross-referencing}
...
\section{MIS of ODE Solver Module} \label{Module_ODE_solver} \wss{Use labels for
  cross-referencing}
...
\section{MIS of Main Module} \label{Module_main} \wss{Use labels for
  cross-referencing}
...
\section{MIS of Playback Module} \label{Module_playback} \wss{Use labels for
  cross-referencing}
...
\section{MIS of Constants Module} \label{Module_constants} \wss{Use labels for
  cross-referencing}
...
\section{MIS of GUI Module} \label{Module_GUI} \wss{Use labels for
  cross-referencing}
...
\begin{itemize}
  \item Hardware Hiding Module (\ref{Module_hardware_hiding})
\end{itemize}
...
\section{MIS of File Output Module} \label{Module_file_output} \wss{Use labels for
  cross-referencing}
...
\section{MIS of Communication Module} \label{Module_communication} \wss{Use labels for
  cross-referencing}

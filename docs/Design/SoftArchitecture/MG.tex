...
\subsubsection{State Module (\mref{mBCM})}
...
Outside of these two instances, the other modules communication is handled through standard Unity or Python internal communication.
...
This call also includes all of the parameters that are specified by the user.
...
After the simulation is ran, the Python script writes the results to a CSV file.

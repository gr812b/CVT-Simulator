...
\begin{description}
  ...
  \item [\refstepcounter{mnum} \mthemnum \label{mCVT}:] CVT Simulation Module
...
\subsubsection{Input Format Module (\mref{mEngineSim})}
...
\subsubsection{Input Format Module (\mref{mExternalForces})}
...
\subsubsection{Input Format Module (\mref{mCVT})}
...
\subsubsection{Input Format Module (\mref{mODESolver})}
...
\subsubsection{Input Format Module (\mref{mMain})}
...
\subsubsection{Input Format Module (\mref{mPlayback})}
...
\subsubsection{Input Format Module (\mref{mVisualizer})}
...
\subsubsection{Input Format Module (\mref{mConstants})}
...
\subsubsection{Input Format Module (\mref{mGUI})}
...
\subsubsection{Input Format Module (\mref{mFileOutput})}
...
\subsubsection{Input Format Module (\mref{mComm})}
...
\subsubsection{Input Format Module (\mref{mController})}
